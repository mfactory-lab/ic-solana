...
fn test_get_account_info() {
    let res = call_update::<_, Option<UiAccount>>(
        "sol_getAccountInfo",
...
#[test]
fn test_get_block() {
    let slot = 290304300u64;
    let conf = RpcBlockConfig {
        transaction_details: Some(TransactionDetails::Signatures),
        ..RpcBlockConfig::default()
    };

    let res = call_update::<_, UiConfirmedBlock>(
        "sol_getBlock",
...
fn test_get_block_commitment() {
    let res = call_update::<_, RpcBlockCommitment>(
...
fn test_get_block_production() {
    let res = call_update::<_, RpcBlockProduction>(
...
fn test_get_cluster_nodes() {
    let res = call_update::<_, Vec<RpcContactInfo>>(
        "sol_getClusterNodes",
        (RpcServices::Mainnet, ()),
...
fn test_get_epoch_info() {
    let res = call_update::<_, EpochInfo>(
        "sol_getEpochInfo",
        (RpcServices::Mainnet, ()),
...
fn test_get_epoch_schedule() {
    let res = call_update::<_, EpochSchedule>(
        "sol_getEpochSchedule",
        (RpcServices::Mainnet, ()),
        r#"{"jsonrpc":"2.0","result":{"firstNormalEpoch":0,"firstNormalSlot":0,"leaderScheduleSlotOffset":432000,"slotsPerEpoch":432000,"warmup":false},"id":1}"#,
    )
        .unwrap();
    assert_eq!(res.slots_per_epoch, 432000);
}
...
fn test_get_highest_snapshot_slot() {
    let res = call_update::<_, RpcSnapshotSlotInfo>(
...
fn test_get_identity() {
    let res = call_update::<_, RpcIdentity>(
        "sol_getIdentity",
        (RpcServices::Mainnet, ()),
...
fn test_get_inflation_governor() {
    let res = call_update::<_, RpcInflationGovernor>(
...
fn test_get_inflation_rate() {
    let res = call_update::<_, RpcInflationRate>(
...
fn test_get_inflation_reward() {
    let res = call_update::<_, Vec<Option<RpcInflationReward>>>(
...
fn test_get_signatures_for_address() {
    let res = call_update::<_, Vec<RpcConfirmedTransactionStatusWithSignature>>(
...
fn test_get_slot_leaders() {
    let res = call_update::<_, Vec<String>>(
        "sol_getSlotLeaders",
...
#[test]
fn test_get_supply() {
    let res = call_update::<_, RpcSupply>(
        "sol_getSupply",
        (RpcServices::Mainnet, ()),
...
fn test_get_token_supply() {
    let res = call_update::<_, UiTokenAmount>(
        "sol_getTokenSupply",
...
fn test_get_token_accounts_by_delegate() {
    let res = call_update::<_, Vec<RpcKeyedAccount>>(
...
fn test_token_largest_accounts() {
    let res = call_update::<_, Vec<RpcTokenAccountBalance>>(
...
fn test_get_largest_accounts() {
    let res = call_update::<_, Vec<RpcAccountBalance>>(
...
fn test_get_latest_blockhash() {
    let res = call_update::<_, RpcBlockhash>(
...
fn test_get_leader_schedule() {
    let res = call_update::<_, RpcLeaderSchedule>(
...
fn test_get_multiple_accounts() {
    let res = call_update::<_, Vec<UiAccount>>(
...
fn test_get_recent_performance_samples() {
    let res = call_update::<_, Vec<RpcPerfSample>>(
...
fn test_get_recent_prioritization_fees() {
    let res = call_update::<_, Vec<RpcPrioritizationFee>>(
...
fn test_get_signature_statuses() {
    let res = call_update::<_, Vec<Option<TransactionStatus>>>(
...
fn test_get_transaction() {
    let res = call_update::<_, Option<EncodedConfirmedTransactionWithStatusMeta>>(
        "sol_getTransaction",
        (
            RpcServices::Mainnet,
            (),
...
#[test]
fn test_get_version() {
    let res = call_update::<_, RpcVersionInfo>(
        "sol_getVersion",
        (RpcServices::Mainnet, ()),
...
fn test_vote_accounts() {
    let res = call_update::<_, RpcVoteAccountStatus>(
        "sol_getVoteAccounts",
        (RpcServices::Mainnet,),
...
fn test_simulate_transaction() {
    let res = call_update::<_, RpcSimulateTransactionResult>(
